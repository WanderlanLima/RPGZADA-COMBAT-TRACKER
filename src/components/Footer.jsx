      ...
      return (
        <footer className="p-4 text-gray-500 text-xs mt-auto border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center border-b md:border-r border-gray-700 pb-2 md:pb-0 md:pr-4">
            ...
            <div className="border-b md:border-r border-gray-700 py-2 md:py-0 md:pr-4">
